    ...
    if (this.state.showRealApp) {
      return (
          <Container>
            ...
            <Content padder={false} contentContainerStyle={custom.videoContainer} style={responsive.content}>
              ...
              <View>
                <Animatable.Text animation="zoomInUp" style={responsive.homeDescriptionText}>
                  <Text>
                    ...
                    {"\n"}
                    Подобрете организацията на Вашата фирма с помощта на нашето приложение.
                    {"\n"}
