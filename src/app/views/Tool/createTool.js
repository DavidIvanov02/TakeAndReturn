...
class createTool extends React.Component {
    ...
    _handleCreate = () => {
        ...
        this.setState({tool_nameError: tool_nameError, tool_descriptionError: tool_descriptionError, tool_countError: tool_countError, tool_availabilityError: tool_availabilityError});
            ...
            if (!tool_descriptionError) {
                if (!tool_countError) {
                    if (!tool_availabilityError) {
                        ...
                        if (tool_availability === "Има го в наличност" && tool_count === "0") {
                            that.setState({tool_countError: 'Въведете валиден брой на инструмента!'});
                        }

                        else if (tool_availability === "Няма го в наличност" && tool_count === "1") {
                            that.setState({tool_availabilityError: 'Въведете наличност на инструмента!'});
                        }
