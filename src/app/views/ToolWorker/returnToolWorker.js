...
class returnToolWorker extends React.Component {
    ...
    componentDidMount() {
        ...
        NfcManager.setEventListener(NfcEvents.DiscoverTag, tag => {this.tagTouched(tag) });
    }
    /* /Component Did Mount Method - Here We Mount Component - Data/ */
    ...
    _handleReturn = () => {
        ...
        this.setState({tool_nameError: tool_nameError, date_takeError: date_takeError, hour_takeError: hour_takeError, date_returnError: date_returnError, hour_returnError: hour_returnError, worker_pincodeError: worker_pincodeError, nfcTagValueError: nfcTagValueError});
    ...
    render() {
        ...
        if (this.state.isNfcSupported) {
            passwordField = (
                <View>
                    <View style={responsive.NFCView}>
                        <NFC isScanned={this.state.nfcTagValue != null}/>
                    </View>
                    <View>
                        <Text style={responsive.NFCErrorText}>{nfcTagValueError ? nfcTagValueError : null} </Text>
                    </View>
                </View>
            );
        }
