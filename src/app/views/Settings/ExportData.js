    ...
    render() {
        ...
        return (
            <Content style={custom.content}>
                ...
                <View style={responsive.settingsDataButtonView}>
                    <DefaultButton title="Експорт" buttonStyle={responsive.settingsDataButtonStyle} onPress={this._exportData} disabled={disabled}/>
                </View>
                <View>
