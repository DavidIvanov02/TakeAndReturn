            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата отсъстващи работници е базирана на принципа CRUD (Create, Read, Update, Delete). Това означава, че можем да добавяте, преглеждате, редактирате и премахвате отсъствие на работник. A самата страница съдържа календар, който се състои от снимка, име на работника, презиме на работника, фамилия на работника и дата на отсъствие.</Text>сс
                    </View>
