            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Нека започнем с това, че работниците са базирани на принципа CRUD (Create, Read, Update, Delete). Това означава, че можете да добавяте, преглеждате, редактирате и премахвате работник. Също така имаме търсачка, чрез която улесняваме търсенето на определен работник, а самата страница съдържа списък със създадени от вас работници, които се състоят от снимка, име, презиме, фамилия, имейл, телефон, адрес и парола.</Text>
                    </View>
