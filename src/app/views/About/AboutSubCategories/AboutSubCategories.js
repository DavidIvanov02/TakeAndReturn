            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Нека започнем с това, че подкатегориите са базирани на принципа CRUD (Create, Read, Update, Delete). Това означава, че можете да добавяте, преглеждате, редактирате и премахвате подкатегория. Също така имаме търсачка, чрез която улесняваме търсенето на определена подкатегория, а самата страница съдържа списък със създадени от вас подкатегории, които се състоят от снимка и име.</Text>
                    </View>
