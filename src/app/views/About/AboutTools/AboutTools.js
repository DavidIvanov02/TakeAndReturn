            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Нека започнем с това, че инструментите са базирани на принципа CRUD (Create, Read, Update, Delete). Това означава, че можете да добавяте, преглеждате, редактирате и премахвате инструмент. Също така имаме търсачка, чрез която улесняваме търсенето на определен инструмент, а самата страница съдържа списък със създадени от вас инструменти, които се състоят от снимка, име, описание, брой и наличност.</Text>
                    </View>
