...
class createAbsence extends Component {
    ...
    _handleCreate = () => {
        ...
        this.setState({worker_idError: worker_idError, worker_fnameError: worker_fnameError, worker_snameError: worker_snameError, worker_lnameError: worker_lnameError, worker_reasonError: worker_reasonError, date_absenceError: date_absenceError});
