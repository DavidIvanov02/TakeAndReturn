...
class createWorker extends React.Component {
    ...
    _handleCreate = () => {
        ...
        this.setState({worker_fnameError: worker_fnameError, worker_snameError: worker_snameError, worker_lnameError: worker_lnameError, worker_emailError: worker_emailError, worker_mobileError: worker_mobileError, worker_addressError: worker_addressError, worker_pincodeError: worker_pincodeError, nfcTagValueError: nfcTagValueError});
        ...
        if (!worker_pincodeError || nfcTagValue) {
            db.transaction(function (tx) {
                tx.executeSql(
                    'INSERT INTO table_worker (worker_fname, worker_sname, worker_lname, worker_email, worker_mobile, worker_address, worker_pincode) VALUES (?,?,?,?,?,?,?)', [worker_fname, worker_sname, worker_lname, worker_email, worker_mobile, worker_address, (nfcTagValue ? nfcTagValue : worker_pincode)], (tx, results) => {
